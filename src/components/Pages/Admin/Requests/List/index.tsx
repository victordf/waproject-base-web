          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCellSortable paginationParams={params} onChange={mergeParams} column='amount'>
                  Quantidade
                </TableCellSortable>
                <TableCellSortable paginationParams={params} onChange={mergeParams} column='value'>
                  Valor
                </TableCellSortable>
                <TableCell></TableCell>
              </TableRow>
